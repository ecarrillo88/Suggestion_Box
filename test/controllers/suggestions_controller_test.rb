...
class SuggestionsControllerTest < ActionController::TestCase
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post :create, suggestion: { author: @suggestion.author, comment: @suggestion.comment, email: @suggestion.email, title: @suggestion.title }
    end
  ...
  test "should update suggestion" do
    patch :update, id: @suggestion, suggestion: { author: @suggestion.author, comment: @suggestion.comment, email: @suggestion.email, title: @suggestion.title }
    assert_redirected_to suggestion_path(assigns(:suggestion))
  end
